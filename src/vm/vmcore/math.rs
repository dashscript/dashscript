...
pub fn floor_api(args: Vec<Value>, _vm: &mut VM) -> Value {
    Value::Num(arg_to_float(args.get(0)).floor())
}

pub fn trunc_api(args: Vec<Value>, _vm: &mut VM) -> Value {
    Value::Num(arg_to_float(args.get(0)).trunc())
}

pub fn ceil_api(args: Vec<Value>, _vm: &mut VM) -> Value {
    Value::Num(arg_to_float(args.get(0)).ceil())
}

pub fn round_api(args: Vec<Value>, _vm: &mut VM) -> Value {
    Value::Num(arg_to_float(args.get(0)).round())
}

pub fn abs_api(args: Vec<Value>, _vm: &mut VM) -> Value {
    Value::Num(arg_to_float(args.get(0)).abs())
}

pub fn sqrt_api(args: Vec<Value>, _vm: &mut VM) -> Value {
    Value::Num(arg_to_float(args.get(0)).sqrt())
}

pub fn sin_api(args: Vec<Value>, _vm: &mut VM) -> Value {
    Value::Num(arg_to_float(args.get(0)).sin())
}

pub fn cos_api(args: Vec<Value>, _vm: &mut VM) -> Value {
    Value::Num(arg_to_float(args.get(0)).cos())
}

pub fn tan_api(args: Vec<Value>, _vm: &mut VM) -> Value {
    Value::Num(arg_to_float(args.get(0)).tan())
}

pub fn random_api(_args: Vec<Value>, _vm: &mut VM) -> Value {
    Value::Num(Rng::new().random() as fsize / u32::MAX as fsize)
}

pub fn random_int_api(_args: Vec<Value>, _vm: &mut VM) -> Value {
    Value::Num(Rng::new().random() as fsize)
}

pub fn random_range_api(args: Vec<Value>, vm: &mut VM) -> Value {
